      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div className="space-y-6">
          ...
          <div className="flex gap-4">
            ...
            <a href="https://instagram.com/dnshop.iphone" target="_blank" rel="noopener noreferrer" onClick={() => trackSocial('instagram')} className="hover:text-white transition-colors"><Instagram size={20} /></a>
            <a href="https://instagram.com/dnshop.fragancias" target="_blank" rel="noopener noreferrer" onClick={() => trackSocial('instagram')} className="hover:text-white transition-colors"><Instagram size={20} /></a>
            {/* <a href="#" onClick={() => trackSocial('facebook')} className="hover:text-white transition-colors"><Facebook size={20} /></a> */}
            {/* <a href="#" onClick={() => trackSocial('twitter')} className="hover:text-white transition-colors"><Twitter size={20} /></a> */}
          </div>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm">
            <li className="flex items-start gap-3">
              ...
              <span>Av. Mitre 450, Cnel Brandsen, Argentina</span>
            </li>
            <li className="flex items-center gap-3">
              <Phone size={18} className="text-blue-500 shrink-0" />
              <span>+542223434403</span>
            </li>
            <li className="flex items-center gap-3">
              <Mail size={18} className="text-blue-500 shrink-0" />
              <span>info@dnshop.com.ar</span>
            </li>
          </ul>
        </div>
      </div>
